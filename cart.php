                            ...
                            <div class="cart-all-pro">
                                <div class="cart-pro">
                                    <div class="cart-pro-image">
                                        <a href="product.php"><img src="image/cart-page/cart-1/image1.jpg"
                                                class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                                        <h4><a href="product.php">Vegetable tomato fresh</a></h4>
                                ...
                                <div class="qty-item">
                                    <div class="center">
                                        ...
                                        <a href="grid-list.php" class="pro-remove">Remove</a>
                                    </div>
                                </div>
                    ...
                    <div class="cart-area">
                        <div class="cart-details">
                            <div class="cart-all-pro">
                                <div class="cart-pro">
                                    <div class="cart-pro-image">
                                        <a href="product.php"><img src="image/cart-page/cart-1/image3.jpg"
                                                class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                                        <h4><a href="product.php">Fresh healthy food</a></h4>
                                        <span class="pro-size"><span class="size">Size:</span> 5kg</span>
                    ...
                    <div class="cart-area">
                        <div class="cart-details">
                            <div class="cart-all-pro">
                                <div class="cart-pro">
                                    <div class="cart-pro-image">
                                        <a href="product.php"><img src="image/cart-page/cart-1/image2.jpg"
                                                class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                                        <h4><a href="product.php">Fresh green orange</a></h4>
                                        <span class="pro-size"><span class="size">Size:</span> 5kg</span>
                            ...
                            <div class="other-link">
                                <ul class="c-link">
                                    <li class="cart-other-link"><a href="grid-list.php">Update cart</a></li>
                                    <li class="cart-other-link"><a href="grid-list.php">Continue shopping</a></li>
                                    <li class="cart-other-link"><a href="index.php">Clear cart</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
